...
//        Configs.init("zfbinfo.properties");
        ...
        Configs.setPid("2088102052595924");
        //沙箱domain
...
//        Configs.setOpenApiDomain("https://openapi.alipay.com/gateway.do");
    ...
    public void test_trade_precreate() {
        ...
        Observable.just(0).subscribeOn(Schedulers.io()).map(integer -> tradeService.tradePrecreate(builder))
...
//                        Bitmap bm = CodeUtils.createCode(response.getQrCode(), logo);
//                        // 将二维码在界面中显示
